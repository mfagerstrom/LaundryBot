...
export function buildLaundryComponents(row, helpRequests) {
...
export function getLaundryButtonId() {
    return LAUNDRY_BUTTON_ID;
}
export function getHelpButtonId() {
    return HELP_BUTTON_ID;
}
export function getHelpDoneButtonId() {
    return HELP_DONE_BUTTON_ID;
}
export function getCompleteButtonId() {
    return COMPLETE_BUTTON_ID;
}
export function getHelpSelectId(messageId) {
    return `${HELP_SELECT_ID}:${messageId}`;
}
export function parseHelpSelectId(customId) {
...
export function getHelpDoneSelectId(messageId) {
    return `${HELP_DONE_SELECT_ID}:${messageId}`;
}
export function parseHelpDoneSelectId(customId) {
    const [prefix, messageId] = customId.split(":");
...
export function buildHelpSelectMenu(messageId) {
...
export function buildHelpDoneSelectMenu(messageId, helpRequests) {
    const select = new StringSelectMenuBuilder()
        ...
        .addOptions(helpRequests.map((request) => ({
